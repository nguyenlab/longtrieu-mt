...
public class Pivot {
    ...
    public static void triangulation_filter(String src_pvtTable, String pvt_trgTable, String src_test, String trg_test, int workers, int nbest) {
        ...
        extractOverlapPhrases("triangulation/bin-table/phrases.src", src_test, "triangulation/filter", "phrases.src");
        extractOverlapPhrases("triangulation/bin-table/phrases.trg", trg_test, "triangulation/filter", "phrases.trg");

        filterPhraseTable_SrcPvt("triangulation/bin-table/phrase-table.src-pvt", "triangulation/filter/phrases.src", "triangulation/filter", "phrase-table.src-pvt", "phrases.src-pvt.pvt");
        filterPhraseTable_PvtTrg("triangulation/bin-table/phrase-table.pvt-trg", "triangulation/filter/phrases.trg", "triangulation/filter", "phrase-table.pvt-trg", "phrases.pvt-trg.pvt");

        System.out.println("-----------------------------------------------------------------\n");

        commonPivot("triangulation/filter/phrases.src-pvt.pvt", "triangulation/filter/phrases.pvt-trg.pvt", "triangulation/common", "phrases.common.pvt");
        commonPivot_SrcPvtTable("triangulation/filter/phrase-table.src-pvt", "triangulation/common/phrases.common.pvt", "triangulation/common", "phrase-table.src-pvt", "phrases.src");
        commonPivot_PvtTrgTable("triangulation/filter/phrase-table.pvt-trg", "triangulation/common/phrases.common.pvt", "triangulation/common", "phrase-table.pvt-trg", "phrases.trg");
        ...
        normalizeFilteredScores("triangulation/index/tables", "triangulation/index/phrases/phrases.src.index.bin", "triangulation/index/phrases/phrases.pvt.index.bin", "phrase-table.src-pvt.index.bin", "phrase-table.src-pvt.index.norm.bin");
        normalizeFilteredScores("triangulation/index/tables", "triangulation/index/phrases/phrases.pvt.index.bin", "triangulation/index/phrases/phrases.trg.index.bin", "phrase-table.pvt-trg.index.bin", "phrase-table.pvt-trg.index.norm.bin");

        System.out.println("-----------------------------------------------------------------\n");
        System.out.println("TRANING: TRIANGULATION\n");
        System.out.println("Threads: " + workers);

        triangulation("triangulation/index/phrases/phrases.src.index.bin", "triangulation/index/tables/phrase-table.src-pvt.index.norm.bin", "triangulation/index/tables/phrase-table.pvt-trg.index.norm.bin", "triangulation/pivot/scores", "triangulation/pivot", "triangulation.scores", workers);
