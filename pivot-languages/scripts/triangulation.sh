...
workers=20
n_best=10
out_dir=$PWD/triangulation/$src_lang-$trg_lang/$pvt_lang
mkdir -p $out_dir
...
#---------------------------------------
# reordering
./scripts/triangulation/reordering.sh $src_lang $trg_lang $pvt_lang

#---------------------------------------
# genrate tables
./scripts/triangulation/generate-tables.sh $src_lang $trg_lang $pvt_lang