...
config_dir=tuning/multi-pivot/$src_lang-$trg_lang/$pvt1_lang-$pvt2_lang-$pvt3_lang/weights/mert-work
decode_dir=decode/multi-pivot/$src_lang-$trg_lang/$pvt1_lang-$pvt2_lang-$pvt3_lang/weights
mkdir -p $decode_dir
