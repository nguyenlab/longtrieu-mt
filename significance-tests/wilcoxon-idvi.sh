...
decode_bleu_multi_fast $SRCLANG $TRGLANG "surface-lemma-(tune)" $IN_DIR 400 $CONFIGS"/surface-lemma-(tune)"

decode_bleu_multi_fast $SRCLANG $TRGLANG "surface" $IN_DIR 200 $CONFIGS"/surface"
decode_bleu_multi_fast $SRCLANG $TRGLANG "surface-lemma-(tune)" $IN_DIR 200 $CONFIGS"/surface-lemma-(tune)"